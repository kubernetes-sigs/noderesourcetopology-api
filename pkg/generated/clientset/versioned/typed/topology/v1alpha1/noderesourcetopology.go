...
type NodeResourceTopologyInterface interface {
	...
	Apply(ctx context.Context, nodeResourceTopology *topologyv1alpha1.NodeResourceTopologyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NodeResourceTopology, err error)
...
// Apply takes the given apply declarative configuration, applies it and returns the applied nodeResourceTopology.
func (c *nodeResourceTopologies) Apply(ctx context.Context, nodeResourceTopology *topologyv1alpha1.NodeResourceTopologyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NodeResourceTopology, err error) {
	if nodeResourceTopology == nil {
		return nil, fmt.Errorf("nodeResourceTopology provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
	data, err := json.Marshal(nodeResourceTopology)
	if err != nil {
		return nil, err
	}
	name := nodeResourceTopology.Name
	if name == nil {
		return nil, fmt.Errorf("nodeResourceTopology.Name must be provided to Apply")
	}
	result = &v1alpha1.NodeResourceTopology{}
