...
func (c *FakeNodeResourceTopologies) Apply(ctx context.Context, nodeResourceTopology *topologyv1alpha1.NodeResourceTopologyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NodeResourceTopology, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(noderesourcetopologiesResource, *name, types.ApplyPatchType, data), &v1alpha1.NodeResourceTopology{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeResourceTopology), err
